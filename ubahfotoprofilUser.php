...
if (isset($_POST['id'])) {
    ...
    if ($foto_size > 5097152) {
       ...
       header("location:ProfilUser.php?pesan=size");
       ...
       if ($foto_nama != "") {
          ...
          if(in_array($ekstensi, $ekstensi_izin) === true)  {
            ...
            $query = mysqli_query($koneksi, "UPDATE user SET foto ='$foto_nama_new' WHERE id_user='$id'");
            ...
            header("location:ProfilUser.php?pesan=ekstensi");        }

        }else{
            header("location:ProfilUser.php?pesan=kosong");
        }
