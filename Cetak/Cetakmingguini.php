...
$mahasiswa = mysqli_query($koneksi, "SELECT * FROM booking JOIN user ON booking.id_user = user.id_user JOIN paket ON booking.id_paket = paket.id_paket WHERE tgl_booking = DATE(NOW) ORDER BY id_booking DESC");
$column_id = "";
$column_nama = "";
$column_paket = "";
$column_status = "";
