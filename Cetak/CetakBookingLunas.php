...
$query = mysqli_query($koneksi,"SELECT * FROM booking JOIN user ON booking.id_user = user.id_user JOIN paket ON booking.id_paket = paket.id_paket WHERE keterangan_bayar ='lunas' ORDER BY id_booking DESC");
$row = mysqli_num_rows($query);
if($row>0){
$html = '<center><h2>Dyah Ayu Salon</h2><h3>Laporan Data Pemesanan Paket Pernikahan (Status Pembayaran : Lunas)</h3></center><hr><br/>
';
...
$dompdf->stream('LaporanPesanan_Lunas.pdf',array("Attachment"=>0));
}else{
